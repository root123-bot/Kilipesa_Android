...
function CoordinatesFarm({ navigation }) {
  ...
  function addRecordHandler() {
    ...
    AsyncStorage.setItem("page4", JSON.stringify(metadata));
        ...
        >
          ...
          >
              ...
              {Platform.OS === "ios" ? (
                <>
                  ...
                  <Picker
                    ...
                    style={[
                      styles.pickedStyling,
                      { display: toggleCurrentUse },
                    ]}
                  >
                ...
                <>
                  <View style={{ marginTop: "2%" }}>
                    <Text style={{ marginLeft: "3%" }}>Select current use</Text>
                    <View
                      style={{
                        borderColor: "black",
                        borderRadius: 5,
            ...
            /> */}
              ...
              <View style={styles.dropdownContainer}>
                ...
                <Dropdown
                  ...
                  value={
                    currentCrop.value.trim().length > 0
                      ? currentCrop.value
                      : null
                  }
            ...
            >
              <Button
                mode="contained"
                onPress={() => navigation.navigate("Records3")}
...
export default CoordinatesFarm;
